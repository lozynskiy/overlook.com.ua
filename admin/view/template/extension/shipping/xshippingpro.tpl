...
.well-days, .well-desc, .product-category, .product-product, .product-option{ display:block;}
      ...
      +'<ul class="nav nav-tabs" id="method-tab-__INDEX__">'
         ...
         +'<div class="tab-pane" id="price___INDEX__">'
           ...
           +'<div class="form-group">'
                  ...
                  +'<div class="col-sm-10"><input type="text" name="xshippingpro[display]" value="" class="form-control" id="input-display__INDEX__" /></div>'
            +'</div>'
           +'</div>'
		   +'</div>' 
        +'</div>';

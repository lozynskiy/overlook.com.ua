...
<?php echo $header; ?>
	...
	<style>
		...
		.mdp_heading{border-bottom:2px solid #4f9d5d;margin-bottom:30px;}
		h1.heading_title{font:500 34px 'Roboto';display:inline-block;vertical-align:top;}
		.mdp_buttons{float:right;}		
		.mdp_button{text-decoration:none;border:0px;border-bottom:1px solid #fff;display:inline-block;padding:10px 20px;cursor:pointer;font:16px/20px 'Open Sans';color:#fff!important;}
		.yellow{background:#ffbf00;}
		.green{background:#4f9d5d;}
		...
		.activate_steeps>div span{display:block;border:4px solid #ffbf00;color:#4f9d5d;position:absolute;top:20px;left:-25px;background:#fff;width:46px;height:46px;border-radius:23px;font:bold 22px/38px 'Open Sans';text-align:center;}
		h2.sh2{font:500 18px/32px 'Roboto';color:#555;}
		input.s_input{display:block;margin:10px 0 10px 0;width:500px;border:1px solid #ccc;padding:5px 10px;font:14px/20px 'Open Sans';color:#333;border-radius:0px;}
		textarea.textarea{width:500px;margin:10px 0 10px 0;border:1px solid #4f9d5d;padding:10px;height:90px;}
		input.s_input:focus, input.s_input:active{border-color:#4f9d5d;}
		...
		.mdp_success{display:none;margin-top:-30px;margin-bottom:30px;background:#4f9d5d;text-align:center;font:16px/30px Arial;height:30px;color:#fff;}
		.mdp_tabs{height:36px;}
		.mdp_tabs:after{display:block;content:'';float:none;clear:both;}
		.mdp_tabs>div{cursor:pointer;border:1px solid #4f9d5d;border-bottom:0;float:left;height:36px;font:16px/36px Arial;text-align:center;padding:0 20px;}
		.mdp_tabs>div+div{border-left:0;}
		.mdp_tabs>div.active{background:#4f9d5d;color:#fff;height:36px;}
		.mdp_tabs_data{padding:20px;border:1px solid #4f9d5d;font-size:14px;margin-bottom: 60px;}
		...
		#clear_old{cursor:pointer;border-bottom:1px dashed #4f9d5d;color:#4f9d5d;display:inline-block;}
			...
			<div class="mdp_tabs_data">
				<div class="mdp_general active">
					...
					<table class="mdp_form">
						...
						<?php } ?>
						<tr>
							<td><?php echo $text_links; ?></td> 
							<td>
								<?php echo $text_control_in; ?> <a target="_blank" href="https://search.google.com/structured-data/testing-tool">google.com</a><br>
								<?php echo $text_control_in; ?> <a target="_blank" href="https://webmaster.yandex.ru/tools/microtest/">yandex.ru</a><br>
						</tr>
					</table>
				</div>
				<div class="mdp_company">
					<table class="mdp_form">
						...
						<?php } ?>
						<tr>
						  <td><a href="" target="_blank" title="<?php echo $text_info_title; ?>"><?php echo $text_config_company; ?></a></td>
						...
						<tr>
						  <td><a href="" target="_blank" title="<?php echo $text_info_title; ?>"><?php echo $text_company_syntax; ?></a></td>
						  <td>
						...
						<tr>
						  <td><a href="" target="_blank" title="<?php echo $text_info_title; ?>"><?php echo $text_entry_telephone; ?></td>
						  <td>
							<div class="ib">
						...
						<tr>
						  <td><a href="" target="_blank" title="<?php echo $text_info_title; ?>"><?php echo $text_entry_group; ?></a></td>
						  <td>
							<div class="ib">
							<span class="placeholder_name"><?php echo $store_name; ?></span>
						...
						<tr>
							<td><a href="" target="_blank" title="<?php echo $text_info_title; ?>"><?php echo $text_city; ?></a></td>
							<td>
							<div class="ib">
							<span class="placeholder_name"><?php echo $store_name; ?></span>
						...
						<tr>
							<td><a href="" target="_blank" title="<?php echo $text_info_title; ?>"><?php echo $text_code; ?></a></td>
							<td>
							<div class="ib">
							<span class="placeholder_name"><?php echo $store_name; ?></span>
						...
						<tr>
							<td><a href="" target="_blank" title="<?php echo $text_info_title; ?>"><?php echo $text_street; ?></a></td>
							<td>
							<div class="ib">
							<span class="placeholder_name"><?php echo $store_name; ?></span>
						...
						<tr>
							<td><a href="" target="_blank" title="<?php echo $text_info_title; ?>"><?php echo $text_entry_email; ?></a></td>
							<td>
							<div class="ib">
							<span class="placeholder_name"><?php echo $store_name; ?></span>
				...
				<div class="mdp_product">
					<table class="form">
						<tr>
						  <td><a href="" target="_blank" title="<?php echo $text_info_title; ?>"><?php echo $text_page; ?></a></td>
						...
						<tr>
						  <td><a href="" target="_blank" title="<?php echo $text_info_title; ?>"><?php echo $text_breadcrumb; ?></a></td> 
						...
						<tr>
						  <td><a href="" target="_blank" title="<?php echo $text_info_title; ?>"><?php echo $text_reviews; ?></a></td> 
						...
						<tr>
						  <td><a href="" target="_blank" title="<?php echo $text_info_title; ?>"><?php echo $text_related; ?></a></td>
						...
						<tr>
						  <td><a href="" target="_blank" title="<?php echo $text_info_title; ?>"><?php echo $text_attribute; ?></a></td>
						...
						<tr>
						  <td><a href="" target="_blank" title="<?php echo $text_info_title; ?>"><?php echo $text_in_stock; ?></a></td>
						...
						<tr>
						  <td><a href="" target="_blank" title="<?php echo $text_info_title; ?>"><?php echo $text_in_stock_status; ?></a></td>
							  <td>
						...
						<tr>
						  <td><a href="" target="_blank" title="<?php echo $text_info_title; ?>"><?php echo $text_sku; ?></a></td>
						...
						<tr>
						  <td><a href="" target="_blank" title="<?php echo $text_info_title; ?>"><?php echo $text_upc; ?></a></td>
						...
						<tr>
						  <td><a href="" target="_blank" title="<?php echo $text_info_title; ?>"><?php echo $text_ean; ?></a></td>
						...
						<tr>
						  <td><a href="" target="_blank" title="<?php echo $text_info_title; ?>"><?php echo $text_isbn; ?></a></td>
						...
						<tr>
						  <td><a href="" target="_blank" title="<?php echo $text_info_title; ?>"><?php echo $text_mpn; ?></a></td>
						...
						<tr>
						  <td><a href="" target="_blank" title="<?php echo $text_info_title; ?>"><?php echo $text_syntax; ?></a></td>
						  <td>
						...
						<tr>
						  <td><a href="" target="_blank" title="<?php echo $text_info_title; ?>"><?php echo $text_entry_product; ?></a></td>
				...
				<div class="mdp_category">
					<table class="form">
						...
						<tr>
						  <td><a href="" target="_blank" title="<?php echo $text_info_title; ?>"><?php echo $text_entry_category; ?></a></td>
				...
				<div class="mdp_manufacturer">
					<table class="form">
						...
						<tr>
						  <td><a href="" target="_blank" title="<?php echo $text_info_title; ?>"><?php echo $text_entry_manufacturer; ?></a></td>
				...
				<div class="mdp_special">
					<table class="form">
						...
						<tr>
						  <td><a href="" target="_blank" title="<?php echo $text_info_title; ?>"><?php echo $text_entry_special; ?></a></td>
	...
	<script>
		...
		$(document).ready(function() {
			setInterval('pingServer()', 60000);
 			<?php if(!$activated){ ?>
			  $.ajax({
				url: '<?php echo $link_status; ?>&token=<?php echo $token; ?>',
				type: 'post',
				dataType: 'json',
		...
		$('#clear_old').click(function(){
 			$.ajax({
				url: '<?php echo $link_clear; ?>&token=<?php echo $token; ?>',
				type: 'post',
				dataType: 'json',
				beforeSend: function() {

<?php
// Heading
$_['heading_title']    = 'Мои способы доставки';
...
$_['text_edit']        = 'Редактировать Мои способы доставки';
...
$_['text_price_setting']    = 'Настройка цен';
...
$_['text_rate_total_coupon']    = 'Total without coupon';
...
$_['text_manufacturer_rule'] = 'Услоявия по производителям';
...
$_['entry_group_name']       = 'Group Method Name (Optional)';
$_['text_admin_name'] = 'Показывать название';
$_['text_admin_name_tip'] = 'For admin only. It will show in order detail.';

/* tooltip */
$_['tip_group_name']       = 'Method name will be replaced by provided group name. It is possible to insert original method name and price into group name. For putting name, rule is method number preceded by #. For example, #1 means first method name. Similarly for price use @. For example, @1 means first method price.';
...
$_['tip_multi_category']       = 'The option is only applicable when your product resides under more than one category.<br /><b>Exact</b>: It will consider only selected categories listed below in the time of evaluating regardless of product categories.<br /><b>Any</b>: All categories of a product will be considered while evaluating either you select all or not. If you are not sure, just keep the default value';
...
$_['text_equation_help'] = 'Available parameters {cartTotal}, {cartQnty}, {cartWeight} {shipping}, {modifier}. Ex. {cartTotal}-5*{cartQnty}';

$_['text_option'] = 'Product Option Rule';
$_['text_option_any'] = 'For any Product Option';
$_['text_option_all'] = 'Must have selected options';
$_['text_option_least'] = 'Any of the selected options';
$_['text_option_least_with_other'] = 'Any of the selected options with others';
$_['text_option_exact'] = 'Only for the selected options';
...
$_['tip_option']       = '<b>For any Product Option</b>: Valid for any options.<br /><b>Must have selected options</b>: Selected options must have in the shopping cart with  other options.<br /><b>Any of the selected options with others</b>: At least one of the selected product must have in the shopping cart with  other options.<br /><b>Any of the selected options</b>: At least one of the selected product must have in the shopping cart.  Other options are not allowed.<br /><b>Only for the selected options</b>: All cart options should be in the selected options. Other options are not allowed.<br /><b>Except the selected product</b>: Shopping cart should not have any of the selected options. Only non-selected options are allowed .<br /><b>Except the selected options with others</b>: Shopping cart may have selected options only if cart have at least any other option';

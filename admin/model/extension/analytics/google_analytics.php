<?php
class ModelExtensionAnalyticsGoogleAnalytics extends Model {
	...
	public function getSettings($store_id) {
		$query = $this->db->query("SELECT * FROM " . DB_PREFIX . "setting WHERE `code` = 'google_analytics' AND store_id = '" . $this->db->escape($store_id) . "'");

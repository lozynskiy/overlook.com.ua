...
class ControllerCommonColumnLeft extends Controller {
	public function index() {
		if (isset($this->request->get['token']) && isset($this->session->data['token']) && ($this->request->get['token'] == $this->session->data['token'])) {
            ...
            if ($this->user->hasPermission('access', 'catalog/product_option_group')) {
                $catalog[] = array(
                    'name'	   => $this->language->get('text_product_option_group'),
                    'href'     => $this->url->link('catalog/product_option_group', 'token=' . $this->session->data['token'], true),
                    'children' => array()
                );
            }
			...
			if ($this->user->hasPermission('access', 'catalog/sizechart')) {
				$catalog[] = array(
					...
					'href'     => $this->url->link('catalog/sizechart', 'token=' . $this->session->data['token'], true),
					'children' => array()		
				);
			}

<?php 
	...
	* @property ModelBlogBlog $model_blog_blog
	* @property ModelBlogBlogCategory $model_blog_blog_category
	...
	* @property ModelToolImageNoWhiteBorders $model_tool_image_no_white_borders
	* @property ModelToolOnline $model_tool_online
	* @property ModelToolUpload $model_tool_upload
	* @property ModelBlogBlogComment $model_blog_blog_comment
	* @property ModelBlogBlogSetting $model_blog_blog_setting
	...
	* @property ModelCatalogProductOptionGroup $model_catalog_product_option_group
	* @property ModelCatalogRecurring $model_catalog_recurring
	* @property ModelCatalogSizechart $model_catalog_sizechart
	...
	* @property ModelExtensionMegamenu $model_extension_megamenu
	...
	* @property ModelSaleSmsSending $model_sale_sms_sending

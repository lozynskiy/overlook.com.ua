...
class ModelExtensionShippingXshippingpro extends Model {
	...
	public function getQuote($address) {
		...
		foreach($methods as $single_method) {
			...
			if (!$status) {
				$debugging[]=array('name'=>$xshippingpro['name'][$language_id],'filter'=>$debugging_message,'index'=>$no_of_tab);
			}
			...
			$method_desc= ($xshippingpro['desc'][$language_id]) ? $xshippingpro['desc'][$language_id] : '';

	...
	*/
	...
	initResponsive: function(){
		...
		if( ! jQuery( '.mfilter-free-container' ).length ) {
			...
			cnt = jQuery('<div class="filtersContainer mfilter-free-container mfilter-free-container-closed mfilter-direction-' + self._options.direction + ( self._options.isMobile ? ' mfilter-mobile' : '' ) + '">')

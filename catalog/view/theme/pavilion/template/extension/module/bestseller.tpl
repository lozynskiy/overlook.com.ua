<div class="related-products-grid product-grid">
    ...
    <div class="row bestseller owl-carousel owl-theme">
        <?php foreach ($products as $p => $product) { ?>
            <div class="item-box">
                <div class="product-item">
                    <script>
                        var bestseller<?php echo $product['product_id']; ?> = {
                    ...
                    <div class="picture"><a onclick="GaListLink(bestseller<?php echo $product['product_id']; ?>, GaList.Bestseller); return false;"
                    ...
                    <div class="details">
                        ...
                        <h2 class="product-title"><a onclick="GaListLink(bestseller<?php echo $product['product_id']; ?>, GaList.Bestseller); return false;"
                        ...
                        <div class="add-info">
                            ...
                            <div class="buttons-upper">
                                <input class="button-2 add-to-wishlist-button" type="button" data-toggle="tooltip"
                                       ...
                                       onclick="GaListAddToWishlist(bestseller<?php echo $product['product_id']; ?>, GaList.Bestseller)">
                                <input class="button-2 add-to-compare-list-button" type="button" data-toggle="tooltip"
                                       title="<?php echo $button_compare; ?>"
                                       onclick="GaListAddToCompare(bestseller<?php echo $product['product_id']; ?>, GaList.Bestseller)">
                            </div>
                            <div class="buttons-lower">
                                <button class="button-2 product-box-add-to-cart-button" type="button"
                                        onclick="GaListAddToCart(bestseller<?php echo $product['product_id']; ?>, GaList.Bestseller, 1)">
    ...
    <script>
        if (typeof ga != 'undefined') {
            ...
            ga('ec:addImpression', {
                ...
                'category': '<?php echo $product['category']; ?>',
                'brand': '<?php echo $product['manufacturer']; ?>',
                'list': GaList.Bestseller,
                'position': <?php echo $p; ?>
            });
            <?php } ?>
            ga('send', 'event', 'Ecommerce', 'Impression', GaList.Bestseller, {'nonInteraction': 1});
        }
    </script>
    <script>

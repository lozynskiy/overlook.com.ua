<div class="related-products-grid product-grid">
    ...
    <div class="row latest owl-carousel owl-theme">
        <?php foreach ($products as $p => $product) { ?>
            <div class="item-box">
                <div class="product-item">
                    <script>
                        var latest<?php echo $product['product_id']; ?> = {
                    ...
                    <div class="picture"><a onclick="GaListLink(latest<?php echo $product['product_id']; ?>, GaList.Latest); return false;"
                    ...
                    <div class="details">
                        ...
                        <h2 class="product-title"><a onclick="GaListLink(latest<?php echo $product['product_id']; ?>, GaList.Latest); return false;"
                        ...
                        <div class="add-info">
                            ...
                            <div class="buttons-upper">
                                <input class="button-2 add-to-wishlist-button" type="button" data-toggle="tooltip"
                                       ...
                                       onclick="GaListAddToWishlist(bestseller<?php echo $product['product_id']; ?>, GaList.Latest)">
                                <input class="button-2 add-to-compare-list-button" type="button" data-toggle="tooltip"
                                       title="<?php echo $button_compare; ?>"
                                       onclick="GaListAddToCompare(bestseller<?php echo $product['product_id']; ?>, GaList.Latest)">
                            </div>
                            <div class="buttons-lower">
                                <button class="button-2 product-box-add-to-cart-button" type="button"
                                        onclick="GaListAddToCart(bestseller<?php echo $product['product_id']; ?>, GaList.Latest, 1)">
    ...
    <script>
        if (typeof ga != 'undefined') {
            ...
            <?php } ?>
            ga('send', 'event', 'Ecommerce', 'Impression', GaList.Latest, {'nonInteraction': 1});
        }
    </script>
    <script>

                    ...
                    <?php } ?>
                        ...
                        <table class="compare-products-table">
                            ...
                            <tr class="specification">
                                ...
                                <?php foreach ($products as $product) { ?>
                                <td style="width: <?php echo $width; ?>"><?php echo $product['length']; ?> x <?php echo $product['width']; ?> x <?php echo $product['height']; ?>
                                </td>
                                <?php } ?>
                            </tr>
                            </tbody>
                            ...
                            <tr class="specification">
                                ...
                                <?php foreach ($products as $product) { ?>
                                <td style="width: <?php echo $width; ?>">
                                    <input type="button" class="button-2 add-to-cart-button" title="<?php echo $button_cart; ?>"
                                           onclick="cart.add('<?php echo $product['product_id']; ?>', '<?php echo $product['minimum']; ?>');"/>
                                    <input onclick="setLocation('<?php echo $product['remove']; ?>')"
                                       class="button-2 remove-button" title="<?php echo $button_remove; ?>" />
                                </td>
                                <?php } ?>
                            </tr>
                        </table>

        ...
        <div class="product-essential" itemscope="" itemtype="http://schema.org/Product">
        	<div class="gallery sevenspikes-cloudzoom-gallery">
        		<?php if ($thumb || $images) { ?>
        		  <div class="picture-wrapper">
        		    <?php if ($thumb) { ?>
        		    	<a class="fancybox" rel="gallery" href="<?php echo $popup; ?>" title="<?php echo $heading_title; ?>">
        		    		<img class="main-thumbnail" data-zoom-image="<?php echo $popup; ?>" itemprop="image" src="<?php echo $thumb; ?>" title="<?php echo $heading_title; ?>" alt="<?php echo $heading_title; ?>" />
        		    	</a>
        		    <?php } ?>
        		  </div>
        		  ...
        		  <?php foreach ($images as $image) { ?>
                       <a class="fancybox" rel="gallery" href="<?php echo $image['popup']; ?>" data-image="<?php echo $image['image']; ?>" data-zoom-image="<?php echo $image['popup']; ?>" title="<?php echo $heading_title; ?>">
         ...
         <div class="product-reviews-overview">
          ...
          <div class="short-description">
            ...
            <?php } ?>
            <span class="label"><?php echo $text_stock; ?></span><span class="value"><?php echo $stock; ?></span>
          </div>
          ...
          <div id="product" class="attributes">
            ...
            <div class="form-group">
              ...
              <ul class="option-list attribute-squares color-squares" id="input-option<?php echo $option['product_option_id']; ?>">
                <?php foreach ($option['product_option_value'] as $option_value) { ?>
                <li>
                <?php if ($option_value['image']) { ?>
                  <label for="option-<?php echo $option['product_option_id']; ?>-<?php echo $option_value['product_option_value_id']; ?>" data-toggle="tooltip" data-trigger="hover" title="<?php echo $option['name']; ?> <?php echo $option_value['name']." "; if ($option_value['price']) { ?><?php echo $option_value['price_prefix']; ?><?php echo $option_value['price']; ?><?php } ?>">
                    <span class="attribute-square-container">
						<span class="attribute-square">
                    		<img src="<?php echo $option_value['image']; ?>" alt="<?php echo $option_value['name'] . ($option_value['price'] ? ' ' . $option_value['price_prefix'] . $option_value['price'] : ''); ?>" class="img-thumbnail" /> 
						</span>
					</span>
                    <input id="option-<?php echo $option['product_option_id']; ?>-<?php echo $option_value['product_option_value_id']; ?>" type="radio" name="option[<?php echo $option['product_option_id']; ?>]" value="<?php echo $option_value['product_option_value_id']; ?>" />
	              </label>
	              <?php } else { ?>
	                <label for="option-<?php echo $option['product_option_id']; ?>-<?php echo $option_value['product_option_value_id']; ?>" data-toggle="tooltip" data-trigger="hover" title="<?php echo $option['name']; ?> <?php echo $option_value['name']." "; if ($option_value['price']) { ?><?php echo $option_value['price_prefix']; ?><?php echo $option_value['price']; ?><?php } ?>">
            ...
            <div class="form-group">
              <label class="text-prompt" for="input-option<?php echo $option['product_option_id']; ?>"><?php echo $option['name']; ?><?php echo ($option['required'] ? '<span class="required">*</span>' : ''); ?></label>
            ...
            <div class="form-group">
              <label class="text-prompt"><?php echo $option['name']; ?><?php echo ($option['required'] ? '<span class="required">*</span>' : ''); ?></label>
              <button type="button" id="button-upload<?php echo $option['product_option_id']; ?>" data-loading-text="<?php echo $text_loading; ?>" class="button-1"><i class="fa fa-upload"></i> <?php echo $button_upload; ?></button>
            ...
            <div class="form-group">
              <label class="text-prompt" class="control-label" for="input-option<?php echo $option['product_option_id']; ?>"><?php echo $option['name']; ?><?php echo ($option['required'] ? '<span class="required">*</span>' : ''); ?></label>
              <div class="input-group time">
                <input type="text" name="option[<?php echo $option['product_option_id']; ?>]" value="<?php echo $option['value']; ?>" data-date-format="HH:mm" id="input-option<?php echo $option['product_option_id']; ?>" />
                <span class="input-group-btn">
                <button type="button" class="button-1"><i class="fa fa-calendar"></i></button>
                </span></div>
            </div>
            ...
            <div class="add-to-cart">
              <div class="add-to-cart-panel">
              	...
              	<input type="text" name="quantity" value="<?php echo $minimum; ?>" size="2" id="input-quantity" class="qty-input"/>
              	<input type="hidden" name="product_id" value="<?php echo $product_id; ?>" />
				<div class="ajax-cart-button-wrapper">
              		<input type="button" id="button-cart" data-loading-text="<?php echo $text_loading; ?>" class="button-1 add-to-cart-button" value="<?php echo $button_cart; ?>" />
              	</div>
              </div>
            </div>
            <div class="overview-buttons">
            	<div class="add-to-wishlist">
            		<input type="button" data-toggle="tooltip" class="button-2 add-to-wishlist-button" title="<?php echo $button_wishlist; ?>" onclick="wishlist.add('<?php echo $product_id; ?>');"/>
            	</div>
            	<div class="compare-products">
            		<input type="button" data-toggle="tooltip" class="button-2 add-to-compare-list-button" title="<?php echo $button_compare; ?>" onclick="compare.add('<?php echo $product_id; ?>');"/>
            	</div>
	        </div>
            <?php if ($minimum > 1) { ?>
          ...
          <div class="productTabs-body tab-content">
            ...
            <div class="tab-pane ui-tabs-panel" id="tab-specification">
              ...
              <table class="data-table">
                ...
                <thead>
                  <tr>
                    <td class="title" colspan="2"><strong><?php echo $attribute_group['name']; ?></strong></td>
                  </tr>
                </thead>
                <tbody>
              ...
              <form class="write-review" id="form-review">
                ...
                <div class="form-fields">
                  <div class="inputs">
                    ...
                    <input type="text" name="name" value="<?php echo $customer_name; ?>" id="input-name" class="review-title" />
                  </div>
                  <div class="inputs">
                    <label for="input-review"><?php echo $entry_review; ?></label>
                    <textarea name="text" rows="5" id="input-review" class="review-text"></textarea>
                ...
                <?php echo $captcha; ?>
                <div class="buttons">
                    <input type="button" id="button-review" data-loading-text="<?php echo $text_loading; ?>" class="button-1 write-product-review-button" value="<?php echo $button_continue; ?>" />
                </div>
                <?php } else { ?>
                <?php echo $text_login; ?>
                <?php } ?>

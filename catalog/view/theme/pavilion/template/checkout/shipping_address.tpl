<form class="form-horizontal">
        ...
        <div id="shipping-existing">
            <select name="address_id" class="address-select">
                <?php foreach ($addresses as $address) { ?>
                    ...
                    <?php } else { ?>
                        <option value="<?php echo $address['address_id']; ?>"><?php echo $address['firstname']; ?>
                            <?php echo $address['lastname']; ?>,
    ...
    <div id="shipping-new" class="new-shipping-address" style="display: <?php echo($addresses ? 'none' : 'block'); ?>;">
        ...
        <div class="inputs">
            <label for="input-shipping-firstname"><?php echo $entry_firstname; ?>
                <span class="required">*</span>
            </label>
                <input type="text" name="firstname" value="" id="input-shipping-firstname"/>
        </div>
        <div class="inputs">
            <label for="input-shipping-lastname"><?php echo $entry_lastname; ?>
                <span class="required">*</span>
            </label>
        ...
        <div class="inputs">
            <label for="input-shipping-address-1"><?php echo $entry_address_1; ?>
                <span class="required">*</span>
            </label>
        ...
        <div class="inputs">
            <label for="input-shipping-city"><?php echo $entry_city; ?>
                <span class="required">*</span>
            </label>
                <input type="text" name="city" value="" id="input-shipping-city"/>
        </div>
        <div class="inputs">
            <label for="input-shipping-postcode"><?php echo $entry_postcode; ?>
                <span class="required">*</span>
            </label>
                <input type="text" name="postcode" value="<?php echo $postcode; ?>" id="input-shipping-postcode"/>
        </div>
        <div class="inputs">
            <label for="input-shipping-country"><?php echo $entry_country; ?>
                <span class="required">*</span>
            </label>
        ...
        <div class="inputs">
            <label for="input-shipping-zone"><?php echo $entry_zone; ?>
                <span class="required">*</span>
            </label>
    ...
    <div class="buttons">
            <input type="button" value="<?php echo $button_continue; ?>" id="button-shipping-address"
                   data-loading-text="<?php echo $text_loading; ?>" class="button-1 new-address-next-step-button"/>
    </div>
</form>
        ...
        $.ajax({
            ...
            success: function (json) {
                if (json['postcode_required'] == '1') {
                    $('#collapse-shipping-address input[name=\'postcode\']').parent().children('label').children('span').addClass('required');
                } else {
                    $('#collapse-shipping-address input[name=\'postcode\']').parent().children('label').children('span').css('display', 'none');
                }

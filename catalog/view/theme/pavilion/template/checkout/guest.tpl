    ...
    <div class="column-2">
        <fieldset id="account">
            ...
            <div class="form-fields">
                ...
                <div class="inputs">
                    <label for="input-payment-firstname"><?php echo $entry_firstname; ?><span class="required">*</span></label>
                    <input type="text" name="firstname" value="<?php echo $firstname; ?>" id="input-payment-firstname"/>
                </div>
                <div class="inputs">
                    <label for="input-payment-lastname"><?php echo $entry_lastname; ?><span
    ...
    <div class="column-2">
        <fieldset id="address">
            ...
            <div class="form-fields">
                ...
                <div class="inputs" style="display:none;">
                    <label for="input-payment-country"><?php echo $entry_country; ?><span
                                class="required">*</span></label>
...
<?php } ?>
<div class="buttons">
    <input type="button" value="<?php echo $button_continue; ?>" id="button-guest"
...
<script>
    $(document).on('change', '#collapse-payment-address input[name=\'agree\']', function () {
        ...
        var NotRegistred = $('input[name=\'customer_group_id\'][value=\'<?php echo $customer_group_id; ?>\']');
        var Registred = $('input[name=\'customer_group_id\'][value=\'<?php echo $customer_register_group_id; ?>\']');

        if (NotRegistred.prop('checked') == true) {
            Registred.prop('checked', true)
        } else {
            NotRegistred.prop('checked', true)
        }
    });

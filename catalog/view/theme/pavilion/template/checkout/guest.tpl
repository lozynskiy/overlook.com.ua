<div class="master-column-wrapper">
  <div class="col-sm-6">
    <fieldset id="account">
      ...
      <div class="inputs">
        <label for="input-payment-lastname"><?php echo $entry_lastname; ?><span class="required">*</span></label>
...
<?php } ?>
<div class="buttons">
    <input type="button" value="<?php echo $button_continue; ?>" id="button-guest" data-loading-text="<?php echo $text_loading; ?>" class="button-1 new-address-next-step-button" />
</div>

...
<div class="master-wrapper-content">
  ...
  <div class="master-column-wrapper"><?php echo $column_left; ?>
    ...
    <div id="content" class="<?php echo $class; ?>"><?php echo $content_top; ?>
      ...
      <ol class="opc" id="accordion">
        <li class="tab-section allow panel panel-default">
          <div class="panel-heading step-title">
            <h4 class="panel-title title"><?php echo $text_checkout_option; ?></h4>
          </div>
        ...
        <li class="tab-section allow allow panel panel-default">
          <div class="panel-heading step-title">
            <h4 class="panel-title title"><?php echo $text_checkout_account; ?></h4>
          </div>
        ...
        <li class="tab-section allow allow panel panel-default">
          <div class="panel-heading step-title">
            <h4 class="panel-title title"><?php echo $text_checkout_payment_address; ?></h4>
          </div>
          <div class="panel-collapse collapse" id="collapse-payment-address">
            <div class="panel-body step a-item"></div>
          </div>
        ...
        <li class="tab-section allow allow panel panel-default">
          <div class="panel-heading step-title">
            <h4 class="panel-title title"><?php echo $text_checkout_shipping_method; ?></h4>
          </div>
        ...
        <li class="tab-section allow allow panel panel-default">
          <div class="panel-heading step-title">
            <h4 class="panel-title title"><?php echo $text_checkout_payment_method; ?></h4>
          </div>
        ...
        <li class="tab-section allow allow panel panel-default">
          <div class="panel-heading step-title">
            <h4 class="panel-title title"><?php echo $text_checkout_confirm; ?></h4>
          </div>

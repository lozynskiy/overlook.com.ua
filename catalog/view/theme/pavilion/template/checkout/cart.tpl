    ...
    <div id="content" class="<?php echo $class; ?>"><?php echo $content_top; ?>
          ...
          <table class="cart">
            <thead>
              <tr class="cart-header-row">
                ...
                <th class="remove-from-cart" data-hide="w410, w480, w580"><?php echo $button_remove; ?></th>
            ...
            <tbody>
              ...
              <tr class="cart-item-row">
                ...
                <td class="quantity">
                    <input type="text" name="quantity[<?php echo $product['cart_id']; ?>]" value="<?php echo $product['quantity']; ?>" size="1" class="qty-input" />
                </td>
                <td class="unit-price "><span class="product-unit-price"><?php echo $product['price']; ?></span></td>
                <td class="subtotal"><span class="product-subtotal"><?php echo $product['total']; ?></span></td>
              </tr>
              <?php } ?>
              <?php foreach ($vouchers as $voucher) { ?>
              <tr>
                <td class="remove-from-cart"></td>
                <td class="product-picture"><?php echo $voucher['description']; ?></td>
                <td class="product"></td>
                <td class="quantity">
                ...
                <td class="unit-price"><span class="product-unit-price"><?php echo $voucher['amount']; ?></span></td>
                <td class="subtotal"><span class="product-subtotal"><?php echo $voucher['amount']; ?></span></td>
              </tr>
              <?php } ?>
            </tbody>
          </table>
      ...
      <div class="totals">
        <div class="total-info">
          <table class="cart-total">
            ...
            <tr>
              ...
              <td class="cart-total-right"><span class="value-summary"><?php echo $total['text']; ?></span></td>
            </tr>
            <?php } else { ?>
        ...
        <div class="checkout-buttons">
          <a href="<?php echo $checkout; ?>" class="button-1 checkout-button"><?php echo $button_checkout; ?></a>
        </div>
      </div>
          </div>

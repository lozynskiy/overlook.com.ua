<form class="form-horizontal">
    ...
    <?php } ?>
    <br/>
    <div id="payment-new" class="section new-billing-address"
         style="display: <?php echo($addresses ? 'none' : 'block'); ?>;">
        <div class="enter-address">
            <div class="edit-address">
                <div class="inputs">
                    <label for="input-payment-firstname"><?php echo $entry_firstname; ?>
                ...
                <div class="inputs">
                    <label for="input-payment-lastname"><?php echo $entry_lastname; ?>
                        <span class="required">*</span>
                    </label>
                ...
                <div class="inputs">
                    <label for="input-payment-address-1"><?php echo $entry_address_1; ?>
                        <span class="required">*</span>
                    </label>
                ...
                <div class="inputs">
                    <label for="input-payment-city"><?php echo $entry_city; ?>
                        <span class="required">*</span>
                    </label>
                ...
                <div class="inputs">
                    <label for="input-payment-zone"><?php echo $entry_zone; ?>
                        <span class="required">*</span>
                    </label>
    ...
    <div class="buttons">
        <input type="button" value="<?php echo $button_continue; ?>" id="button-payment-address"
        ...
        $.ajax({
            ...
            success: function (json) {
                if (json['postcode_required'] == '1') {
                    $('#collapse-payment-address input[name=\'postcode\']').parent().children('label').children('span').addClass('required');
                } else {
                    $('#collapse-payment-address input[name=\'postcode\']').parent().children('label').children('span').css('display', 'none');
                }

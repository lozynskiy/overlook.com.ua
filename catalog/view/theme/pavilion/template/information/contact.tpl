...
<!--div class="center-1">
                            ...
                            <div class="master-column-wrapper">
                                <?php if ($image) { ?>
                                    <div class="col-sm-3"><img src="<?php echo $image; ?>" alt="<?php echo $store; ?>"
                                                               title="<?php echo $store; ?>" class="img-thumbnail"/>
                                    </div>
                                <?php } ?>
                                                ...
                                                <div class="col-sm-3">
                                                    ...
                                                    <?php if ($location['geocode']) { ?>
                                                        <a href="https://maps.google.com/maps?q=<?php echo urlencode($location['geocode']); ?>&hl=<?php echo $geocode_hl; ?>&t=m&z=15"
                                                           target="_blank" class="btn btn-info"><i
                                                                    class="fa fa-map-marker"></i> <?php echo $button_map; ?>
                                                        </a>
                                                    <?php } ?>
                                                </div>
                                                <div class="col-sm-3">
                ...
                <div class="page-body">
                    ...
                    <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data">
                        <div class="fieldset">
                            <div class="form-fields">
                                <div class="inputs">
                                    ...
                                    <?php if ($error_name) { ?>
                                        <div class="field-validation-error"><?php echo $error_name; ?></div>
                                    <?php } ?>
                                </div>
                                <div class="inputs">
                                ...
                                <div class="inputs">
                                    ...
                                    <textarea name="enquiry" rows="10"
                                              id="input-enquiry"><?php echo $enquiry; ?></textarea>
                                    <?php if ($error_enquiry) { ?>
                                        <div class="field-validation-error"><?php echo $error_enquiry; ?></div>
                                    <?php } ?>
                                </div>
                                <?php echo $captcha; ?>
                            </div>
                        ...
                        <div class="buttons">
                            <input class="button-1 contact-us-button" type="submit"

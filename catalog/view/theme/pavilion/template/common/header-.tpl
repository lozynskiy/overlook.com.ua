...
<div class="header">
    <nav id="top" class="header-upper">
        <div class="center">
            <div id="top-links">
                <?php echo $currency; ?>
                <?php echo $language; ?>
                <div class="header-links-wrapper"><a href="<?php echo $account; ?>" title="<?php echo $text_account; ?>"
                ...
                <div class="header-selectors-wrapper"><label><a href="<?php echo $shopping_cart; ?>"
                                                                title="<?php echo $text_shopping_cart; ?>"><i
                                    class="fa fa-shopping-cart"></i> <span
                                    class="hidden-xs hidden-sm hidden-md"><?php echo $text_shopping_cart; ?></span></a></label>
                </div>
            </div>
        </div>
    </nav>
    ...
    <div class="header-lower">
        <div class="center">
            <div id="megamenu-menu" class="category-navigation-list-wrapper">
                ...
                <div class="collapse navbar-collapse navbar-ex1-collapse no-padding">
                    <ul class="category-navigation-list sticky-flyout">
                        ...
                        <li class="has-sublist <?php if($type == " full
                        " || $type_full == "manufacturer"){echo"new-drop";} elseif($type ==
                        "full_image"){echo"new-drop";}
                        elseif($item['type']=="product"){echo"new-drop";} else {echo"";}?>">
                        ...
                        <div class="sublist-wrap categories with-pictures fullWidth boxes-3">
                            <div class="sublist <?php if($item['add_html']){ ?>has-banner<?php } ?>">
                                <div class="inner-wrap">
                                    <?php foreach (array_chunk($item['children'], ceil(count($item['children']) / 1)) as $children) { ?>
                                    <?php if($item['add_html']){ ?>
                                    <div style="" class="menu-add-html">
                                    ...
                                    <ul class="row">
                                        ...
                                        <li class="box">
                                            ...
                                            <ul class="subcategories">
                                                <?php foreach ($child['children'] as $subchild) { ?>
                                                <li>
                                                    <a href="<?php echo $subchild['href']; ?>"><span><?php echo $subchild['name']; ?></span></a>
                                                </li>
                                                <?php } ?>
                                            </ul>
                                            <?php } ?>

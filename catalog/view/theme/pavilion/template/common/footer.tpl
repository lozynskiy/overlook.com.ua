    ...
    <div class="footer-upper">
        <div class="center">
            <div class="newsletter" id="static-subscribe-wrapper-footer">
                ...
                <div class="newsletter-subscribe">
                    <form id="static-subscribe-form-footer" class="newsletter-email">
                        <input id="newsletter"
                               class="newsletter-subscribe-text input-text required-entry validate-email"
                               placeholder="<?php echo $text_subscribe_email; ?>"
                               title="<?php echo $text_subscribe_email; ?>" type="text" name="email">
                        <button class="button-1 newsletter-subscribe-button" id="static-subscribe-button-footer"
            ...
            <ul class="social-sharing">
                <li class="facebook"><a href="https://www.facebook.com/overlook.ua" target="_blank"></a></li>

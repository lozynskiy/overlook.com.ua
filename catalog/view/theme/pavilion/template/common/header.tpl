...
<nav id="top" class="header-upper">
  <div class="center">
    <div id="top-links">
		<?php echo $currency; ?>
    	<?php echo $language; ?>
        <div class="header-links-wrapper"><a href="<?php echo $account; ?>" title="<?php echo $text_account; ?>" class="dropdown-toggle" data-toggle="dropdown"><label><i class="fa fa-user"></i> <span class="hidden-xs hidden-sm hidden-md"><?php echo $text_account; ?></span> <span class="caret"></span></a></label>
          <ul class="header-links">
            ...
            <li><a class="ico-login modal-login" href="<?php echo $login; ?>"><?php echo $text_login; ?></a></li>
	    	<li><a class="ico-wishlist" href="<?php echo $wishlist; ?>" id="wishlist-total" title="<?php echo $text_wishlist; ?>"><?php echo $text_wishlist; ?></a></li>
            <?php } ?>
          </ul>
        </div>
        <div class="header-selectors-wrapper"><label><a href="<?php echo $shopping_cart; ?>" title="<?php echo $text_shopping_cart; ?>"><i class="fa fa-shopping-cart"></i> <span class="hidden-xs hidden-sm hidden-md"><?php echo $text_shopping_cart; ?></span></a></label></div>
    </div>
  </div>
</nav>
<header class="header-middle">
  <div class="center">
      <div class="header-logo">
        <div id="logo">
          <?php if ($logo) { ?>
              <a class="logo" <?php if ($home != $og_url) { ?>href="<?php echo $home; ?>"<?php } ?>><img src="<?php echo $logo; ?>" title="<?php echo $name; ?>" alt="<?php echo $name; ?>" class="img-responsive" /></a>
          <?php } else { ?>
...
<div class="responsive-nav-wrapper-parent" style="z-index: 1070;">
...
<div class="k-list-container k-popup k-group k-reset" id="small-searchterms-list" data-role="popup" style="display: none; position: absolute;"><ul unselectable="on" class="k-list k-reset" tabindex="-1" role="listbox" aria-hidden="true" id="small-searchterms_listbox" aria-live="polite" style="overflow: auto;"></ul></div></form>
</div>
</div>
</div>
<?php if($use_megamenu) { ?>

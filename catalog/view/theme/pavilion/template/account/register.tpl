            ...
            <div id="content" class="<?php echo $class; ?>"><?php echo $content_top; ?>
                    ...
                    <div class="page-body">
                        ...
                        <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data"
                            ...
                            <fieldset id="account">
                                ...
                                <div class="inputs">
                                    <label for="input-lastname"><?php echo $entry_lastname; ?><span class="required">*</span></label>
                                ...
                                <div class="inputs">
                                    <label for="input-telephone"><?php echo $entry_telephone; ?><span class="required">*</span></label>
                ...
                <button type="button" class="btn btn-default"><i class="fa fa-calendar"></i></button>
                            ...
                            <fieldset id="address">
                                ...
                                <div class="inputs">
                                    <label for="input-address-1"><?php echo $entry_address_1; ?><span class="required">*</span></label>
                                ...
                                <div class="inputs">
                                    <label for="input-city"><?php echo $entry_city; ?><span class="required">*</span></label>
                                ...
                                <div class="inputs">
                                    <label for="input-postcode"><?php echo $entry_postcode; ?><span class="required">*</span></label>
                                ...
                                <div class="inputs">
                                    <label for="input-zone"><?php echo $entry_zone; ?><span class="required">*</span></label>
                ...
                <button type="button" class="btn btn-default"><i class="fa fa-calendar"></i></button>
                            ...
                            <fieldset>
                                ...
                                <div class="title">
                                    ...
                                    <div class="form-fields">
                                <div class="inputs">
                                    <label for="input-password"><?php echo $entry_password; ?><span class="required">*</span></label>
                                    <input type="text" name="password" value="<?php echo $password; ?>" id="input-password"/>
                                        <?php if ($error_password) { ?>
                                        <div class="field-validation-error"><?php echo $error_password; ?></div>
                                        <?php } ?>
                                </div>
                                <div class="inputs">
                                    <label for="input-confirm"><?php echo $entry_confirm; ?><span class="required">*</span></label>
                                    <input type="text" name="confirm" value="<?php echo $confirm; ?>" id="input-confirm"/>
                            ...
                            <fieldset>
                                ...
                                <div class="inputs">
                                    ...
                                    <ul class="option-list">
                                        <li>
                                        <input id="newsletter-yes" type="radio" name="newsletter" value="1" checked="checked"/>
                                    ...
                                    <ul class="option-list">
                                        ...
                                        <li>
                                        <input id="newsletter-no" type="radio" name="newsletter" value="0" checked="checked"/>
                                        <label for="newsletter-no"><?php echo $text_no; ?></label>
                                        </li>
                                    </ul>
                                        <?php } ?>

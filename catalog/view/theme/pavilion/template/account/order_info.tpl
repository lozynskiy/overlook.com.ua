                    ...
                    <div class="page-body">
                        <div class="order-overview">
                            ...
                            <div class="order-total">
                                <?php echo end($totals)['title']; ?>:
                                <strong><?php echo end($totals)['text']; ?></strong>
                            </div>
                        </div>
                            ...
                            <div class="table-wrapper">
                                <table class="data-table">
                                    ...
                                    <tr>
                                        ...
                                        <?php if ($products) { ?>
                                            <th class="action" style="width: 150px"
                                        ...
                                        <?php } else { ?>
                                            <tr>
                                                <td class="cart-total-left">
                                                    <label><?php echo $total['title']; ?></label></td>
                                                <td class="cart-total-right">
                                                    <strong><?php echo $total['text']; ?></strong></td>
                                            </tr>
                                        <?php } ?>
                                    <?php } ?>
                                    </tbody>
                                ...
                                <div class="table-wrapper">
                                    <table class="data-table">
                                        ...
                                        <?php } else { ?>
                                            <tr>
                                                <td colspan="3"
                                                    class="cart-total-center"><?php echo $text_no_results; ?></td>
                                            </tr>
                                        <?php } ?>
                                        </tbody>
                                    </table>

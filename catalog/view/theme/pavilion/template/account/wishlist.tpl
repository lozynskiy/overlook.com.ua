                        ...
                        <div class="table-wrapper">
                            <table class="cart">
                                ...
                                <tr>
                                    ...
                                    <th class="model" data-hide="w410, w480, w580"><?php echo $column_model; ?></th>
                                    <th class="stock" data-hide="w410, w480, w580"><?php echo $column_stock; ?></th>
                                    <th class="unit-price" ><?php echo $column_price; ?></th>
                                    <th class="action" data-hide="w410, w480, w580, w768"><?php echo $column_action; ?></th>
                                </tr>
                                </thead>
                                <tbody>

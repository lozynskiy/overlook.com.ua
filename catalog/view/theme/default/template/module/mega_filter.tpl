...
<div style="display: none;">
    ...
    <?php } ?>
    <div class="nopAjaxFilters7Spikes filtersContainer box mfilter-box mfilter-box-<?php echo (int) $_idx; ?> mfilter-<?php echo $_position; ?><?php echo ! empty( $hide_container ) ? ' mfilter-hide-container' : '' ?><?php echo ! empty( $_displayOptionsAs ) && $_displayOptionsAs == 'modern_horizontal' ? ' mfilter-hide' : ''; ?> mfilter-direction-<?php echo $direction; ?>" id="mfilter-box-<?php echo (int) $_idx; ?>"
         id="mfilter-box-<?php echo (int)$_idx; ?>">
        <div class="close-filters"><span>close</span></div>
                ...
                <?php foreach ($filters as $kfilter => $filter) { ?>
                    ...
                    <li
                        ...
                        <?php } ?>
                            ...
                            class="block filter-block mfilter-filter-item mfilter-<?php echo $filter['type']; ?> mfilter-<?php echo $base_type; ?><?php echo $base_type == 'attribute' ? ' mfilter-attributes' : ($base_type == 'option' ? ' mfilter-options' : ($base_type == 'filter' ? ' mfilter-filters' : '')); ?>"
                    >

                        <?php if ($filter['collapsed'] != 'hide_header' && !empty($filter['name']) && empty($filter['hide_header'])) { ?>
                            <div class="title mfilter-heading<?php
                            ...
                            ?>">
                                <a class="toggleControl"><?php echo $filter['name']; ?></a>
                                <i class="mfilter-head-icon"></i>
                            </div>
                        <?php } ?>

                        <div class="filtersGroupPanel mfilter-content-opts"<?php
                                        ...
                                        <?php if ($base_type == 'categories') { ?>
                                            <div class="mfilter-category mfilter-category-<?php echo $filter['type']; ?>">
                                                ...
                                                <?php } else if ($filter['type'] == 'tree') { ?>
                                                    ...
                                                    <ul class="mfilter-tb"
                                                        data-top-url="<?php echo $filter['top_url']; ?>"
                                                        data-top-path="<?php echo $filter['top_path']; ?>">
                                                        <?php foreach ($filter['categories'] as $category) { ?>
                                                            ...
                                                            <li class="mfilter-tb-as-tr">
                                                                <div class="mfilter-tb-as-td">
                                                                    <a href="#" data-id="<?php echo $category['id']; ?>"
                                                                       data-parent-id="<?php echo $category['pid']; ?>"><?php echo $category['name']; ?></a>
                                                                </div>
                                                                <div class="mfilter-tb-as-td mfilter-col-count"><span
                                                                            class="mfilter-counter"><?php echo $category['cnt']; ?></span>
                                                                </div>
                                                            </li>
                                                        <?php } ?>
                                                    </ul>
                                                        ...
                                                        <?php foreach ($filter['categories'] as $category) { ?>
                                                            ...
                                                            <div class="mfilter-option mfilter-tb-as-tr<?php echo $category['cnt'] ? '' : ' mfilter-hide'; ?><?php echo $tmpCatShown == 1 && $tmpCatIdx > $tmpCatShown ? ' mfilter-first-child' : ''; ?>">
                                                                ...
                                                                <label class="mfilter-tb-as-td"
                                                                       for="mfilter-cat_checkbox-<?php echo (int)$_idx; ?>-<?php echo $category['id']; ?>">
                                                                    <?php echo $category['name']; ?>
                                                                </label>
                                                                <div class="mfilter-tb-as-td mfilter-col-count"><span
                                                                            class="mfilter-counter<?php echo !empty($params['path']) && in_array($category['id'], $params['path']) ? ' mfilter-close' : ''; ?>"><?php echo $category['cnt']; ?></span>
                                                                </div>
                                                            </div>
                                                        <?php } ?>
                                                    </div>
                                            ...
                                            <div class="mfilter-tb">
                                                <?php for ($i = 5; $i >= 1; $i--) { ?>
                                                    <div class="mfilter-option mfilter-tb-as-tr">
                                                        ...
                                                        <label class="mfilter-tb-as-td"
                                                               for="mfilter-opts-rating-<?php echo (int)$_idx; ?>-<?php echo $i; ?>">
                                                            <?php echo $i; ?> <img
                                                                    src="catalog/view/theme/default/stylesheet/mf/images/stars-<?php echo $i; ?>.png"
                                                                    alt=""/>
                                                        </label>
                                                        <div class="mfilter-tb-as-td mfilter-col-count"><span
                                            ...
                                            <div class="mfilter-options-container">
                                                <div class="mfilter-tb">
                                                    ...
                                                    <?php foreach ($filter['options'] as $option_id => $option) {
                                                        if ($option['name'] === '' || isset($options_tmp[$option['key']])) continue;
                                                        $options_tmp[$option['key']] = true; ?>
                                                        ...
                                                        <div class="mfilter-option mfilter-tb-as-tr">
                                                            ...
                                                            <label class="mfilter-tb-as-td"
                                                                   for="mfilter-opts-attribs-<?php echo (int)$_idx; ?>-<?php echo $base_id; ?>-<?php echo $option['key']; ?>">
                                                                <?php if (in_array($_tmp_type, array('image_list_radio', 'image_list_checkbox'))) { ?>
                                                                    ...
                                                                    <img src="<?php echo $option['image']; ?>"
                                                                         width="<?php echo $w; ?>"
                                                                         height="<?php echo $h; ?>"/> <?php echo $option['name']; ?>
                                                                <?php } else { ?>
                                            ...
                                            <div class="mfilter-tb">
                                                <div class="mfilter-option mfilter-select mfilter-vehicles">
                                                    ...
                                                    foreach ($filter['options'] as $k => $v) { ?>
                                                        <select class="form-control mf_selectpicker"
                                                                data-type="vehicle-<?php echo $k; ?>">
                                                        ...
                                                        <li class="mfilter-option mfilter-image">
                                                            <input
                                                                ...
                                                                <?php echo !empty($params[$filter['seo_name']]) && in_array($option['value'], $params[$filter['seo_name']]) ? ' checked="checked"' : ''; ?>
                                                                    value="<?php echo str_replace('"', '&quot;', $option['value']); ?>"/>
                                                            <label for="mfilter-opts-attribs-<?php echo (int)$_idx; ?>-<?php echo $base_id; ?>-<?php echo $option['key']; ?>"
                                                                   title="<?php echo $option['name']; ?>"><img
                                                                        src="<?php echo $option['image']; ?>"/></label>
                                                        </li>
                                                    <?php } ?>
                                                </ul>
                                            </div>

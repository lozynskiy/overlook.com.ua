...
$_['text_note']                               = '<span class="text-danger">Зверніть увагу: HTML не підтримується!</span>';
...
$_['text_trial_description']                  = '%s кожен %d %s до %d платежу(ів) тоді';
$_['text_payment_description']                = '%s кожен %d %s до %d патежу(ів)';
$_['text_payment_cancel']                     = '%s кожен %d %s поки не скасовано';
$_['text_day']                                = 'день';
$_['text_week']                               = 'тиждень';

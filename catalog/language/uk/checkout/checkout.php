...
$_['text_checkout_contact_information']         = '1. Контактна інформація';
$_['text_checkout_payment_shipping_method']     = '2. Оплата і доставка';
$_['text_checkout_confirm_order']               = '3. Підтвердження замовлення';
...
$_['text_shipping_method']           = 'Будь-ласка вкажіть спосіб доставки замовлення:';
$_['text_payment_method']            = 'Будь-ласка вкажіть спосіб оплати замовлення:';
$_['text_comments']                  = 'Додайте коментар до замовлння:';

		...
		if ($category_info) {
			...
			foreach ($results as $result) {
        		...
        		if (isset($result['image']) && $result['image'] !="") { 
        		  ...
        		  $cat_image = $this->model_tool_image->resize("noimages2.png", $this->config->get($this->config->get('config_theme') . '_image_category_width'), $this->config->get($this->config->get('config_theme') . '_image_category_height')); 
        		}
				$data['categories'][] = array(
					'thumb'=> $cat_image,
			...
			$limits = array_unique(array($this->config->get($this->config->get('config_theme') . '_product_limit'), 24, 52, 72, 100));
